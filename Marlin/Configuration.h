...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // A20M, pidtune'd
  #define DEFAULT_Kp 75.93
  #define DEFAULT_Ki 10.65
  #define DEFAULT_Kd 135.28
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 45.76
  #define DEFAULT_bedKi 8.87
  #define DEFAULT_bedKd 157.46
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 472, 472 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 400, 45, 45 }

//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    { 5000, 5000, 50, 5000, 5000 } // ...or, set your own edit limits
#endif
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -37, 0, -2.1 }
